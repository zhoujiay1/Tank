...
res\Toolbar.bmp
    此位图文件用于为工具栏创建平铺图像。
    初始工具栏和状态栏在 CMainFrame 类中构造。使用资源编辑器编辑此工具栏位图，并更新 Tank.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
TankDoc.h、TankDoc.cpp - 文档
    这些文件包含 CTankDoc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CTankDoc::Serialize）。

TankView.h、TankView.cpp - 文档视图
    这些文件包含 CTankView 类。
    CTankView 对象用于查看 CTankDoc 对象。

res\TankDoc.ico
    这是一个图标文件，用作 CTankDoc 类的 MDI 子窗口的图标。此图标包括在主资源文件 Tank.rc 中。
